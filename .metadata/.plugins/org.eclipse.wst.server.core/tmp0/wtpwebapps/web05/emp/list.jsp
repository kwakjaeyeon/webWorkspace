...
<%@ include file="../template/menu.jspf" %>
	<h1>LIST PAGE</h1>
	<p align = "left"><a href = "add.jsp">[입 력]</a></p>
	<table width = "95%" border = "1" cellspacing = "0" align = "center">
		...
		<tr>
			...
			<td><a href="detail.jsp?idx=<%=rs.getString("name") %>"><%=rs.getString("name") %></a></td>
			<td><a href="detail.jsp?idx=<%=rs.getDate("nalja") %>"><%=rs.getDate("nalja") %></a></td>
			<td><a href="detail.jsp?idx=<%=rs.getInt("pay") %>"><%=rs.getInt("pay") %></a></td>
		</tr>
		<%
			}
		}finally{
